...
%>		
	...
	<TR>
		<TD>
			...
			<A HREF="../admin/CatpageM-title-p0.asp?catNo=<%=catNo%>" target=_blank>管理此mainpage標題</A>
			</center>
		</TD>
	</TR>
	</TABLE>
...
<table border="0" topmargin="0" marginwidth="0" marginheight="0" leftmargin="0" align="center">
   ...
   <%
    set rs=server.CreateObject("adodb.recordset")
				...
				if err.number <> 0 then
						...
						<td><A HREF="../admin/GUIsubcatM.asp?catNo=<%=catNo%>" target=_blank >管理sublink</A></td>
				<%rs.Close 
				set rs=nothing
				end if
	%>
  ...
  <A HREF="../admin/CatpageM-layout.asp?catNo=<%=catNo%>" target=_blank>修改所有首頁圖文排版方式</A><br> 
  <A HREF="../admin/catPageM-area-add-p0.asp?catNo=<%=catNo%>" target=_blank>新增圖文段落</A><br>
<%
    set rs=server.CreateObject("adodb.recordset")
				...
				Response.Write "<A HREF=../admin/catpageM-area.asp?id=" & rs("id") & " target=_blank>修改以下之圖文</A>"
