<!--#include file="data.inc"-->
			...
			<A HREF="../admin/logo-p0.asp" target=_blank><IMG SRC="../images/manage_logo.gif" border="0"></A>
			<table width="780" border="0" cellspacing="0" cellpadding="0" height="100">				 
				  <tr>
					...
					<div align="center">
					<img src="../images/logo/<%=rs("logo")%>" align="left">
					
					<br>
					<A HREF="../admin/headline-p0.asp" target=_blank>
					<IMG SRC="../images/manage_title.gif" border="0" ></A>
					<br><%=rs("headline")%>
