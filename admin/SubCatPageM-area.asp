...
Response.Write "<A HREF=SubCatpageM-del.asp?id=" & id & ">刪除此段圖文</A><br>"
set rs=server.CreateObject("adodb.recordset")
	SQLStr="select * from product where id=" & id
...
<br>
<br>
<a href="subcatPageM-area-layout.asp?id=<%=id%>">修改此段圖文排版</a> 
<FORM action="SubcatPageM-area-p1.asp" ENCTYPE="multipart/form-data" METHOD="post" id=form1 name=form1>
